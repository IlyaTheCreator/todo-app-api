 ...
 *           The "id" property contains the ID of the current deleted item.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *           The "id" property contains the ID of the current modified item with deleted completed children.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
